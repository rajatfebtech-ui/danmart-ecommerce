    ...
    <section className="py-12 bg-amber-50/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <span className="text-amber-600 text-xs font-semibold uppercase tracking-widest">Just Arrived</span>
          <h2 className="text-3xl font-bold text-slate-800 mt-1">New Arrivals</h2>
          <p className="text-slate-500 text-sm mt-1">Fresh additions to our collection every week</p>
        </div>
