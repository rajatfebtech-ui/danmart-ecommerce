...
const FeatureProductsPage = () => {
  ...
  useEffect(() => {
    Promise.all([GlobalAxios.get("/product/new"), GlobalAxios.get("/wishlist")])
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <h1 className="text-2xl font-bold text-slate-800 mb-1">Featured Products</h1>
      <p className="text-sm text-slate-500 mb-8">New and noteworthy additions to our collection</p>
